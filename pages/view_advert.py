...
def show_view_advert():
    ...
    with ui.element("main").classes(
        ...
        with ui.row().classes(
            ...
            with ui.row().classes("flex flex-row justify-center w-1/2 h-full"):
                ...
                with ui.column().classes(""):
                    ui.label("Sound Engineering").classes("text-xl font-semibold")
                    ui.label("LLC Records").classes("text-green font-bold")
            ...
            with ui.column().classes("flex flex-col justify-between h-full"):
                with ui.row().classes(
                    ...
                    ui.label("$5000").classes("text-xl font-semibold")
        ...
        with ui.element("div").classes("text-gray-700 w-[95%] "):
            ui.label("Description").classes("text-2xl font-bold text-gray-900 py-5")
            ui.label(
